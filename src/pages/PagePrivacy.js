        ...
        <div className="row">
          <div className="col-sm-8">
            ...
            <p>
              ...
              purpose of our website. This information allows us to provide you
              with a customized and efficient experience. We collect the
              following types of information from our Verite Data Science, LLC
              users:
            </p>
            ...
            <ol>
              ...
              <li>
                ...
                provide additional information. As indicated below, in the
                section titled "Sharing Your Information", you can control how
                your information is displayed and used.
              </li>
            </ol>
            ...
            <ol>
              <li>
                ...
                agents automatically receive and record certain "traffic data"
                on their server logs from your brow top-borderser including your
                IP address, Verite Data Science, LLC cookie information, and the
                page you requested. Verite Data Science, LLC uses this traffic
                data to help diagnose problems with its servers, analyze trends
                and administer the website.
              </li>
              <li>
                Verite Data Science, LLC may collect and, on any page, display
                the total counts that page has been viewed. This includes User
                Profile pages.
              </li>
              <li>
                ...
                provide you with a personalized experience if we cannot
                recognize you, we want you to be aware that these programs are
                available.
              </li>
            </ol>
          </div>
        ...
        <div className="row">
          <div className="col-sm-8">
            ...
            <p>
              ...
              your explicit permission, as detailed in the "Sharing Your
              Information" section below.
            </p>
            <p>
              Verite Data Science, LLC may send out e-mails with Verite Data
              Science, LLC-related news, products, offers, surveys or
              promotions. You may also receive notification e-mails from Verite
              Data Science, LLC, which inform you of actions that have been
              performed on the site.
            </p>
            <p>
              If you do not want to receive e-mail from us, please visit the
              Email Preferences section of your User Profile and/or follow the
        ...
        <div className="row">
          <div className="col-sm-8">
            ...
            <p>
              ...
              us how and when pages in our website are visited and by how many
            ...
            <p>
              ...
              leave the cookies activated because cookies allow you to use some
              of Verite Data Science, LLC's coolest features. Some of our
              business partners, like our advertisers, may use cookies on our
          ...
          <div className="col-sm-8">
            ...
            <ul>
              ...
              <li>
                ...
                Moreover, if Verite Data Science, LLC, or substantially all of
                its assets, were acquired, user information would be one of the
                assets that is transferred.
              </li>
              <li>
                Protection of Verite Data Science, LLC and Others: We may
                release personal information when we believe in good faith that
                release is necessary to comply with a law; to enforce or apply
                our Terms of Use and other policies; or to protect the rights,
                property, or safety of Verite Data Science, LLC, our employees,
              ...
              <li>
                With Your Consent: Except as noted above, we will contact you
                when your personal information is shared with third parties or
                used for a purpose incompatible with the purpose(s) for which it
                was originally collected, and you will be able to opt out to
          ...
          <div className="col-sm-8">
            ...
            <ul>
              <li>
                ...
                by a password for your privacy and security. Protect against
                unauthorized access to your password and to your computer by
                logging off once you have finished using a shared computer.
              </li>
              <li>
                Only employees who need personal information to perform a
                specific job (for example, a customer service representative)
                are granted access to it. All of our employees are kept up to
                date on our privacy and security practices.
              </li>
            </ul>
          </div>
          <div className="col-sm-4 hidden-xs">
          ...
          <div className="col-sm-8">
            ...
            <ul>
              <li>
                ...
                information, but then you may be unable to use certain features
                on our website.
              </li>
              <li>
              ...
              <li>
                However, please note that you will continue to receive all
                system e-mails (e.g. those regarding forgotten user passwords)
                and legal notices (e.g. updates to our policies) from us.
              </li>
            </ul>
          </div>
          <div className="col-sm-4 hidden-xs">
        ...
        <div className="row">
          <div className="col-sm-8">
            ...
            <p>
              ...
              not specifically collect information about children. If we learn
              that Verite Data Science, LLC has collected information from a
              child under the age of 13, we will delete that information as
        ...
        <div className="row">
          <div className="col-sm-8">
            ...
            <p>
              ...
              information is used. If we make changes to the Privacy Policy, we
              will notify you by posting an announcement on the Verite Data
              Science, LLC website so you are always aware of what information
