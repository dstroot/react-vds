        ...
        <div className="row">
          <div className="col-sm-8">
            ...
            <p>
              ...
              corporation and is accessed by you under the Terms of Use
              described below (“Terms”).
            </p>
            <p>
        ...
        <div className="row">
          <div className="col-sm-8">
            ...
            <p>
              ...
              include, but are not limited to, any service and/or content Verite
              Data Science, LLC makes available to or performs for you, as well
              as anything displayed, transmitted or performed on the Site or
              through the Services. Content (“Content”) includes, but is not
              limited to text, information, data, graphics, blog articles,
              photographs, images, illustrations, and software.
            </p>
            <p>
              Your access to and use of the Site may be interrupted from time to
              time as a result of equipment malfunction, updating, maintenance
              or repair of the Site or any other reason within or outside the
              control of Verite Data Science, LLC. Verite Data Science, LLC
              reserves the right to suspend or discontinue the availability of
              the Site and/or any Service and/or remove any Content at any time
              at its sole discretion and without prior notice. Verite Data
              Science, LLC may also impose limits on certain features and
              Services or restrict your access to parts of or all of the Site
              and the Services without notice or liability. The Site should not
              be used or relied upon for storage of your polls you are directed
              to retain your own copies of all Content posted on the Site.
            </p>
          </div>
          <div className="col-sm-4 hidden-xs">
            <h5 className="text-muted">Basically,</h5>
        ...
        <div className="row">
          <div className="col-sm-8">
            ...
            <p>
              ...
              username, and to provide registration information. The
              registration information you provide must be accurate, complete,
              ...
              Verite Data Science, LLC account.
            </p>
            <p>
            ...
            <p>
              ...
              from the use of your password and conducted through your Verite
              Data Science, LLC account.
            </p>
            <p>
              Services are available only to iniduals who are either (i) at
              least 18 years old, or (ii) at least 14 years old, and who are
              authorized to access the Site by a parent or legal guardian. If
              you have authorized a minor to use the Site, you are responsible
              for the online conduct of such minor, and the consequences of any
              misuse of the Site by the minor.
            </p>
          </div>
          <div className="col-sm-4 hidden-xs">
            <h5 className="text-muted">Basically,</h5>
        ...
        <div className="row">
          <div className="col-sm-8">
            ...
            <p>
              ...
              Data Science, LLC are entirely responsible for all Content that
              you post, or otherwise submit to the Site. Verite Data Science,
              LLC does not control user submitted Content and, as such, does not
              guarantee the accuracy, integrity or quality of such Content. You
              understand that by using the Site you may be exposed to Content
            ...
            <p>
              ...
              other purpose not reasonably intended by Verite Data Science, LLC.
            ...
            <ul>
              ...
              <li>
                ...
                proper working of the Site or any activities conducted on the
                Site; or (iii) bypass any measures we may use to prevent or
              ...
              <li>
                To advertise to, or solicit, any user to buy or sell any
                products or services, or to use any information obtained from
                the Services in order to contact, advertise to, solicit, or sell
              ...
              <li>
                ...
                (other than relating to copyright infringement which is
                addressed under “COPYRIGHT COMPLAINTS” below) please send
                written notice to Verite Data Science, LLC.
              </li>
            </ul>
            <p>
              You are solely responsible for your interactions with other users
              of the Site. Verite Data Science, LLC reserves the right, but has
        ...
        <div className="row">
          <div className="col-sm-8">
            ...
            <p>
              ...
              Verite Data Science, LLC will use reasonable efforts to
              investigate notices of alleged Infringement and will take
              appropriate action under applicable intellectual property law and
              these Terms where it believes an Infringement has taken place,
              including removing or disabling access to the Content claimed to
              be infringing and/or terminating accounts and access to the Site.
            </p>
            <p>
              ...
              LLC to make a reasonable determination. Please note that you may
            ...
            <p>
              If we remove or disable access to Content in response to a notice
              of Infringement, we will make reasonable attempts to contact the
              user who posted the affected Content. If you feel that your
              Content is not infringing, you may provide Verite Data Science,
              LLC with a counter notice in writing to the attention of
              “Copyright Infringement Counter Notification”. You must include in
              your counter notice sufficient information to enable Verite Data
              Science, LLC to make a reasonable determination. Please note that
              you may be held accountable for damages (including costs and
              attorneys' fees) if you materially misrepresent that your Content
        ...
        <div className="row">
          <div className="col-sm-8">
            ...
            <p>
              ...
              trademarks, trademarks or trade dress of Verite Data Science, LLC.
              Verite Data Science, LLC’s trademarks and trade dress may not be
              used in connection with any product or service without the prior
              written consent of Verite Data Science, LLC. The images and icons
              available in the Verite Data Science, LLC icon pack may used by
              partners and third party sites in connection with providing
              appropriate links to the Verite Data Science, LLC Site.
            </p>
          </div>
          <div className="col-sm-4 hidden-xs">
            <h5 className="text-muted">Basically,</h5>
        ...
        <div className="row">
          <div className="col-sm-8">
            ...
            <p>
              ...
              action, suits, proceedings, liability, debts, judgments, claims
              and demands whatsoever in law or equity which you ever had, now
              have, or hereafter can, shall or may have, for or by reason of, or
              arising directly or indirectly out of your use of the Site and the
              Services.
            </p>
            <p>
              You hereby agree to indemnify and hold harmless Verite Data
              Science, LLC, its affiliated and associated companies, and their
              ...
              arising out of (i) a breach of these Terms, (ii) Content posted on
              the Site, (iii) the use of the Services, by you or any person
              using your account or Verite Data Science, LLC Username and
              password, or (iv) any violation of any rights of a third party.
            </p>
          </div>
          <div className="col-sm-4 hidden-xs">
            <h5 className="text-muted">Basically,</h5>
        ...
        <div className="row">
          <div className="col-sm-8">
            ...
            <p>
              ...
              with respect to the site, the service or any content (i) for any
              lost profits or Special, indirect, incidental, punitive, or
              consequential damages of any kind whatsoever, (ii)
            </p>
            <p>
              To provide substitute goods or services (however arising), or
              (iii) for any direct damages in Excess of (in the aggregate)
              $100.You must be 14 years and older to register to use the Verite
              Data Science, LLC website. As a result, Verite Data Science, LLC
              does not specifically collect information about children. If we
              learn that Verite Data Science, LLC has collected information from
              a child under the age of 13, we will delete that information as
              quickly as possible. We recommend that minors between the ages of
              14 and 18 ask and receive their parents' permission before using
              Verite Data Science, LLC or sending information about themselves
              or anyone else over the Internet.
            </p>
          </div>
          <div className="col-sm-4 hidden-xs">
            <h5 className="text-muted">Basically,</h5>
        ...
        <div className="row">
          <div className="col-sm-8">
            ...
            <p>
              ...
              kind to bind Verite Data Science, LLC in any respect whatsoever.
              ...
              rights hereunder. Verite Data Science, LLC shall not be liable for
              any failure to perform its obligations hereunder where such
              failure results from any cause beyond Verite Data Science, LLC’s
              reasonable control, including, without limitation, mechanical,
              electronic or communications failure or degradation (including
              "line-noise" interference). If any provision of the Terms is found
              ...
              Data Science, LLC may transfer, assign or delegate the Terms and
              its rights and obligations without consent. The Terms shall be
              governed by and construed in accordance with the laws of Ontario,
              as if made within Ontario between two residents thereof, and the
              parties submit to the exclusive jurisdiction of Ontario courts.
              Both parties agree that the Terms is the complete and exclusive
              ...
              matter of the Terms, and that all modifications must be in a
        ...
        <div className="row">
          <div className="col-sm-8">
            ...
            <p>
              ...
              Science, LLC account, you may simply discontinue using the
        ...
        <div className="row">
          <div className="col-sm-8">
            ...
            <p>
              ...
              alterations constitute a material change to the terms, Verite Data
              Science, LLC will notify you by posting an announcement on the
              site. What constitutes a material change will be determined at
              Verite Data Science, LLC’s sole discretion. You shall be
              ...
              notification of a material change to the terms shall constitute
