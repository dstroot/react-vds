        ...
        <div className="row">
          <div className="col-md-12">
            ...
            <p className="lead">
              ...
              Google's Cloud Platform (GCP) and Micrsoft Azure. However vendor
              lock-in is one concern as this migration occurs. Businesses are
              exploring how to leverage containers and container orchestration
              ...
              leveraging continuous integration directly into a container and
              then to a canary deployment.
            </p>
            <p className="lead">
              Second, companies struggle with employee mobility and te new
              digital workplace. Businesses are realizing that{' '}
              <strong>identity</strong> is the new perimiter. Liberating
              identity is the first step to liberating employees. Liberating
              documents and files is the next step. How do you do this securely,
              and manage the process through the transition?
            </p>
            <p className="lead">
              Finally, big data is big money. We began with the process of
              inspecting, cleansing, transforming, and modeling data with the
              goal of discovering useful information, informing conclusions, and
            ...
            <p className="lead">
              ...
              than purely descriptive purposes. For example, data mining helps
              the financial industry and banking specifically by utilizing
              historical data to identify potential credit risks and to tailor
              loan packages to individual needs.
            </p>
            <p className="lead">
              Predictive analytics focuses on application of statistical models
              for predictive forecasting. An example is buiding predictive
              models that can analyze credit card transations and identify
              possible fraudm or retention risk.
            </p>
          </div>
        </div>
      </div>
