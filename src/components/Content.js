        ...
        <div className="card">
          ...
          <div className="card-body">
            ...
            <p className="card-text">
              ...
              cloud-native technologies such as containers, and cloud container
              orchestration with tools like Kubernetes. These technologies avoid
              cloud infrastructure lock-in and enable the next level of cloud
        ...
        <div className="card">
          ...
          <div className="card-body">
            ...
            <p className="card-text">
              ...
              the right data, applications and tools from anywhere. We are
              changing our culture, including where and when we work, to enable
              enhanced modes of collaboration for our "digital natives".
            </p>
          </div>
        </div>
        <div className="card">
          ...
          <div className="card-body">
            ...
            <p className="card-text">
              ...
              organizing and curating data, while translating it into valuable
              and actionable insights. It's also about how much data to retain,
              and how to ensure destruction when it is no longer relevant.
            </p>
          </div>
        </div>
      </div>
